...
const skills = [
    ...
    },
    {
        ...
        description: "Learning best practices and scalable systems.",
    },
    {
        icon: FaDatabase,
        title: "Database Management",
        description: "Designing and managing databases for applications.",
    },
    {
        icon: FaLightbulb,
    ...
    },
    {
        ...
        description: "Working effectively with teams to achieve project goals.",
    },
    {
        icon: FaCalendarCheck,
        title: "Project Management",
        description: "Organizing and managing projects to ensure timely delivery.",
    },
];
            ...
            <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
             ...
             p-8 h-48"
                    ...
                    >
                        ...
                        <h3 className="text-lg font-semibold text-blue-200">{skill.title}</h3>
